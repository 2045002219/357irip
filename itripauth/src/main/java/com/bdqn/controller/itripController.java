...
public class itripController {
   ...
   ItripUserMapper dao2;
    ...
    @ResponseBody
    public Dto registeremal(@RequestBody ItripUserVO vo,HttpServletRequest request) throws Exception {
    ...
    public static void sentSms(String phone,String message){
        ...
        String accountSId = "8aaf07087f639e2b017f7289c36f04ad";
        String accountToken = "af36dae4af7e428a99d6a1a85973cbb9";
        //请使用管理控制台中已创建应用的APPID
        String appId = "8aaf07087f639e2b017f7289c48c04b4";
